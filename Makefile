...
SRC = ft_isalpha.c ft_strlen.c ft_bzero.c ft_isalnum.c ft_isascii.c ft_isdigit.c\
		...
		ft_strmapi.c ft_striteri.c ft_putchar_fd.c ft_putnbr_fd.c ft_putendl_fd.c\
